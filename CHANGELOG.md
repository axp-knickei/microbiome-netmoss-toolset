...
- **Temporal Workflow Wrapper:** Introduced `scripts/06_temporal_workflow_wrapper.R` to automate the transition from longitudinal tables to consecutive shift plots.
- **Real Data Temporal Wrapper:** Added `scripts/06b_real_temporal_workflow_wrapper.R` with dynamic timepoint selection, feature alignment logic, and placeholders for SparCC and NetMoss2 integration.
